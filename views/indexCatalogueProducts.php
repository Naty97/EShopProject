        ...
        <div id="sidebar-container" class="bg-light border-right">
            ...
            <div class="menu list-group-flush">
                ...
                <ul class="collapse lisst-unstyled" id="homeSubmenu">
                    <a href="#" class="list-group-item list-group-item-action text-muted bg-light p-1 border-0"><i class="fa fa-shopping-bag"></i>&nbsp;&nbsp;Total productos adquiridos</a>
                    <a href="#" class="list-group-item list-group-item-action text-muted bg-light p-1 border-0"><i class="fa fa-money"></i>&nbsp;&nbsp;Monto total de compras realizadas</a>
                </ul>
                <a href="../views/indexCatalogueProducts.php" class="list-group-item list-group-item-action text-muted bg-light p-3 border-0"><i class="fa fa-table"></i>&nbsp;&nbsp;&nbsp; Catálogo de Productos</a>
            </div>
        </div>
        <!-- Fin sidebar -->
